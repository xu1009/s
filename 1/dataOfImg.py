...
class ImgPrint: 
	...
	def GET(self):
		...
		return self.render.reply_tst(self.time_f, self.co2_f, self.pm10_f, self.pm25_f, self.rh_f,self.tem_f)
		#return self.render.bootstrap()
        #return self.render.reply_t()